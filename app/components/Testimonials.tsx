      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <Reveal className="text-center mb-14">
          ...
          <p className="text-slate text-lg max-w-xl mx-auto">
            As a locally-owned home care service, we don't route you through a corporate call center. You get direct, 24/7 personal support — here's exactly what we commit to for every family we serve.
          </p>
        </Reveal>
