    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center">
          <img src="/logo2.png" alt="Waya Care" className="h-16 md:h-20 w-auto drop-shadow-sm" />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          <a
            href="tel:6479244532"
            className="btn-primary text-white text-sm font-semibold px-5 py-2.5 rounded-full inline-flex items-center gap-2 hover:scale-105 transition-transform"
          >
